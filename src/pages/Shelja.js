...
import './profile.css';
import profilepic from '../images/shelja.jpg';
const Shelja = () => {
  return (
    <div class="container mt-4 mb-4 p-3 d-flex justify-content-center">
      <div class="card p-4">
        ...
        <span class="name mt-3"><b>Shelja Bhatia</b></span> 
        <span class="idd">@sb</span>
        ...
        <div class=" px-2 rounded mt-4 date "> <span class="join">9999023654 | Sheljabhatia13@gmail.com</span> </div>
        </div>
      </div>
    </div>
  )
